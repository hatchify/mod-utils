...
// SortedDependingOnAny returns a linked list of FileNodes depending on provided filters
// Note returns all libs if no filters provided
func (libs StringArray) SortedDependingOnAny(subDeps StringArray) (listHead *FileNode, count int) {
	// Parse filters
